...
import me.nylad.sunshine.app.data.WeatherProvider;
...
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
       ...
       Cursor response = mContext.getContentResolver().query(
        ...
        {
            return response.getLong(response.getColumnIndex(WeatherContract.LocationEntry._ID));
        }
        else
        {
