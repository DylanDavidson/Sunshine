...
/**
 * Created by dylandavidson on 5/25/15.
 */
public class WeatherProvider extends ContentProvider {
    ...
    private Cursor getWeather(String selection, String[] selectionArgs, String[] projection, String sortOrder) {
    ...
    private Cursor getLocation(String selection, String[] selectionArgs, String[] projection, String sortOrder) {
        SQLiteDatabase db = mOpenHelper.getReadableDatabase();
        return db.query(
                WeatherContract.LocationEntry.TABLE_NAME,
                projection,
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            // "weather"
            case WEATHER: {
                retCursor = getWeather(selection, selectionArgs, projection, sortOrder);
                break;
            }
            // "location"
            case LOCATION: {
                retCursor = getLocation(selection, selectionArgs, projection, sortOrder);
                break;
            }
